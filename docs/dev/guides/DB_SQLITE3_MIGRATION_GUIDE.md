...
This command updates the target schema file located at `modules/payments/target/scala-3.8.2/resource_managed/main/moleculeGen/MoleculeDomain/MoleculeDomain_Schema_sqlite.sql`.
...
```bash
git diff modules/payments/target/scala-3.8.2/resource_managed/main/moleculeGen/MoleculeDomain/MoleculeDomain_Schema_sqlite.sql
```
