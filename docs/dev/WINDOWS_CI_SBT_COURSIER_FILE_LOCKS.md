...
```
sbt.librarymanagement.ResolveException: Error downloading org.scala-lang:scala3-compiler_3:3.8.4
...
- Using cs.exe to fetch org.scala-lang:scala3-compiler_3:3.8.4 into the isolated cache early.
...
- [`.github/workflows/release-staging.yml`](.github/workflows/release-staging.yml)
  ...
  - Optional: cs.exe prefetch scala3-compiler_3:3.8.4 (may not be essential)
...
& cs.exe fetch org.scala-lang:scala3-compiler_3:3.8.4 --cache "$env:GITHUB_WORKSPACE\.coursier"
```
