...
object CasPratique_15544_FDIM_EX_03
    ...
    val foyer_descr = Ecolabeled_V1(
        ...
        firebox_floor_thickness                 = 80.cm,
        inner_wall_thickness_D1                 = 6.cm,
        outer_wall_thickness_D2                 = 6.cm,
        air_column_thickness_S                  = 2.cm,
        width_between_two_air_columns_sides_E   = 6.cm,
        width_between_two_air_columns_rear_E    = 6.cm,
