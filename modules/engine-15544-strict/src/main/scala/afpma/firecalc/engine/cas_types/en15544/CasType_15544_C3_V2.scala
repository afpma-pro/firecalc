...
object CasType_15544_C3_V2
    ...
    val cas_type_name: String = "v20241001 // cas type EN15544 // C3 V2 = 'Cas pratique V2 (sans chambre de détente)'"

    override val project = ProjectDescr(
        reference = "Cas Type EN15544 // C3 V2 = 'Cas pratique V2'",
        date      = "13/01/2025",
