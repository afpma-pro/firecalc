...
object CasType_15544_C3
    ...
    val foyer_descr = Ecolabeled_V1(
        ...
        width_between_two_air_columns_sides_E   = 4.5.cm, // prop 10% ???
        width_between_two_air_columns_rear_E    = 4.5.cm, // prop 10% ???
        reinforcement_bars_offset_in_corners_R1 = 4.5.cm, // prop 10% ???
        reinforcement_bars_offset_in_corners_R2 = 4.5.cm, // prop 10% ???
        reinforcement_bars_offset_in_corners_R3 = 4.5.cm, // prop 10% ???
