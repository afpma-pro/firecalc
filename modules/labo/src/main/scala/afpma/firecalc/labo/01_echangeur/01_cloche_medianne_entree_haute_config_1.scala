...
object `01_cloche_medianne_entree_haute_config_1`
    ...
    val exercice_name: String =
        "labo // 01_echangeur // 01_cloche_medianne_entree_haute // config 1 // 2023-12-18_15h42m56"
    ...
    val combustionAirPipe =
        ...
        incremental
            ...
            .define(
                ...
                innerShape                (rectangle(27.cm, 16.cm), preventAutoSectionGeometryChange    = true                  ),
    ...
    val fluePipeDescr =
        ...
        Seq (
            ...
            innerShape                  (rectangle(55.4.cm, 55.5.cm), preventAutoSectionGeometryChange = true                            ),
