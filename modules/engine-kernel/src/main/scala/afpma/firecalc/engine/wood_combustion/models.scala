...
abstract class CombustionInputsByMassFlow extends CombustionInputs[Wood.HumidMassFlow]:
    def wood_mass_flow: Wood.HumidMassFlow = qtyIn

abstract class CombustionInputsByMass extends CombustionInputs[Wood.HumidMass]:
