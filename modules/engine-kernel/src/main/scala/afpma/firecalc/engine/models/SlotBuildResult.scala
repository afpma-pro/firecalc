 ...
 * @param upstreamFailure true when an earlier slot in the chain failed to build —
 *                        downstream errors are unreliable and UI should show
 *                        [[afpma.firecalc.engine.standard.ErrorsInOtherSectionType]] instead
 */
