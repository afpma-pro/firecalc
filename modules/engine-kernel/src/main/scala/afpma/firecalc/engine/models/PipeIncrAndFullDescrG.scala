...
object NamedPipeElDescrG:
    given hasLength
        : [PipeElDescr <: Matchable] => (under: HasLength[PipeElDescr]) => HasLength[NamedPipeElDescrG[PipeElDescr]]:
                ...
                findElementsStartingExactlyAt(x) match
                    case sxs if sxs.size > 1 =>
                        ...
                        throw new IllegalStateException(
                            s"multiple elements are starting at (x = $x) :\n ${sxs.mkString("\n")}"
                        )
                    case _                   =>
...
type DirectionChange_15544_or_13384 = en15544.FlowOnlyPipeDescr_15544.DirectionChange |
    en13384.ThermalPipeDescr_13384.DirectionChange
given Show[DirectionChange_15544_or_13384] = Show.show:
    case dc: en15544.FlowOnlyPipeDescr_15544.DirectionChange =>
        Show[en15544.FlowOnlyPipeDescr_15544.DirectionChange].show(dc)
    case dc: en13384.ThermalPipeDescr_13384.DirectionChange  =>
        Show[en13384.ThermalPipeDescr_13384.DirectionChange].show(dc)
