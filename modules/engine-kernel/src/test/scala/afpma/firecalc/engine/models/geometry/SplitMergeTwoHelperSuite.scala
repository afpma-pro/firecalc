...
class SplitMergeTwoHelperSuite extends AnyFlatSpec with Matchers:
    ...
    "SplitMergeTwoHelper.safe" should "succeed for non-collinear directions" in {
        ...
        val result = SplitMergeTwoHelper.safe(i, o1, pos, 0.0)
    ...
    it should "normalize non-unit input directions" in {
        ...
        val plane = SplitMergeTwoHelper.safe(i, o1, pos, 0.0).toOption.get
        assertVec3Approx(plane.incomingDirection, Vec3.Up   )
        assertVec3Approx(plane.branchOneDirection, Vec3.Rear)
    }
    ...
    "branchOneStartPosition" should "equal splitPosition when offset is zero" in {
        ...
        val plane = SplitMergeTwoHelper.safe(i, o1, pos, 0.0).toOption.get
        assertVec3Approx(plane.branchOneStartPosition, pos)
    }
    ...
    "branchOneStartPosition" should "be displaced along branchOneDirection" in {
        ...
        val plane = SplitMergeTwoHelper.safe(i, o1, pos, 2.5).toOption.get
        assertVec3Approx(plane.branchOneStartPosition, Vec3(0, 2.5, 0))
    }

    "branchTwoStartPosition" should "be displaced along reflectedBranchDirection" in {
        val i   = Vec3.Up
        val o1  = Vec3.Rear
        val pos = Vec3(0, 0, 0)
    ...
    "require" should "throw IllegalArgumentException for negative offset" in {
        val i   = Vec3.Up
        val o1  = Vec3.Rear
        val pos = Vec3(0, 0, 0)

        assertThrows[IllegalArgumentException] {
            SplitMergeTwoHelper.safe(i, o1, pos, -1.0)
        }
    }
