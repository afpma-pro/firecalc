...
object FireboxTemplateWriter:
    ...
    private def buildMainSheet(sheet: Sheet, styles: Styles.StyleBundle): Unit =
        ...
        writeFormField(sheet, styles, MbMin, "Masse combustible min", "Min. fuel mass", "kg", Some(10.0), optional = true)
        writeFormField(sheet, styles, MbMax, "Masse combustible max", "Max. fuel mass", "kg", Some(25.0), optional = true)
        ...
        writeFormField(sheet, styles, LowestOpen, "Hauteur plus basse ouverture", "Height of lowest opening", "m", Some(0.05))

        writeSection(sheet, styles, SectionHeat, "Puissance réduite / Reduced Heat Output", 4)
        writeFormField(sheet, styles, HeatMode, "Mode puissance réduite", "Heat output reduced mode", "—", Some("NotDefined"))
    ...
    private def buildPressureLossSheet(sheet: Sheet, styles: Styles.StyleBundle): Unit =
        ...
        addComment(sheet, HeaderRow, SbFirstCol,
