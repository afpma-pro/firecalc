...
object Styles:
    ...
    def create(wb: XSSFWorkbook): StyleBundle =
        ...
        StyleBundle         (
            ...
            enHeader          = style(
                font(bold = true, italic = true, color = GRAY_4D, size = 10),
                fill   = LIGHT_BLUE,
                hAlign = HorizontalAlignment.CENTER
            ),
            unitRow           =
                style(font(color = GRAY_80, size = 10), fill = VERY_LIGHT_GRAY, hAlign = HorizontalAlignment.CENTER),
            ...
            title             = style(
                font(bold = true, color = DARK_BLUE, size = 14),
                hAlign = HorizontalAlignment.CENTER,
                border = false
            ),
            yellowFill        = style(
                font(bold = true, color = DARK_BLUE),
