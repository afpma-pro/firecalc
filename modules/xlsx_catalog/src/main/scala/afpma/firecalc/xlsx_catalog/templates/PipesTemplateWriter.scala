...
object PipesTemplateWriter:
    ...
    private val PipeExample: Seq[Option[Any]] = Seq(
        Some("POUJOULAT 200mm DPI"), Some("WeldedSteel"), Some(0.001), Some("Circle"), Some(0.200), None,
    ...
    private[templates] def buildPipeCasingSheet(
        ...
        addComment(sheet, 2, PipeCols.Layer1Type,
    ...
    private[templates] def buildRoughnessRefSheet(sheet: org.apache.poi.ss.usermodel.Sheet, styles: Styles.StyleBundle): Unit =
        ...
        val h2 = headerRow.createCell(1); h2.setCellValue("Rugosité (m) / Roughness (m)"); h2.setCellStyle(styles.frHeader)
