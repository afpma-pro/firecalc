...
import afpma.firecalc.invoices.templates.InvoiceTemplate
...
trait FireCalcInvoiceFactory:
    ...
    def generateInvoiceWithTemplate[T](
        params  : InvoiceParams,
        template: InvoiceTemplate[T],
        locale  : Locale
...
object FireCalcInvoiceFactory:
    ...
    private class FireCalcInvoiceFactoryImpl(
        ...
        override def generateInvoiceWithTemplate[T](
            params  : InvoiceParams,
            template: InvoiceTemplate[T],
            locale  : Locale
        ): Either[String, InvoiceResult] =
