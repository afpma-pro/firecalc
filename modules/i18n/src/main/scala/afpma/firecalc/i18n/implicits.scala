...
object implicits {
    ...
    given Decoder[I18nData.EN13384.AirSpaceDetailed.VentilDirection] = deriveDecoder[I18nData.EN13384.AirSpaceDetailed.VentilDirection]
    given Decoder[I18nData.EN13384.AirSpaceDetailed.VentilOpenings]  = deriveDecoder[I18nData.EN13384.AirSpaceDetailed.VentilOpenings]
    ...
    given Decoder[I18nData.Inputs_Error.InvalidTypeOfAppliance] = deriveDecoder[I18nData.Inputs_Error.InvalidTypeOfAppliance]
    given Decoder[I18nData.LocalConditions]                 = deriveDecoder[I18nData.LocalConditions]
    given Decoder[I18nData.LocalConditions.ChimneyTermination] = deriveDecoder[I18nData.LocalConditions.ChimneyTermination]
    given Decoder[I18nData.LocalConditions.ChimneyTermination.ChimneyLocationOnRoof] = deriveDecoder[I18nData.LocalConditions.ChimneyTermination.ChimneyLocationOnRoof]
    given Decoder[I18nData.LocalConditions.ChimneyTermination.ChimneyLocationOnRoof.ChimneyHeightAboveRidgeline] = deriveDecoder[I18nData.LocalConditions.ChimneyTermination.ChimneyLocationOnRoof.ChimneyHeightAboveRidgeline]
    given Decoder[I18nData.LocalConditions.ChimneyTermination.ChimneyLocationOnRoof.HorizontalDistanceBetweenChimneyAndRidgeline] = deriveDecoder[I18nData.LocalConditions.ChimneyTermination.ChimneyLocationOnRoof.HorizontalDistanceBetweenChimneyAndRidgeline]
    given Decoder[I18nData.LocalConditions.ChimneyTermination.ChimneyLocationOnRoof.Slope] = deriveDecoder[I18nData.LocalConditions.ChimneyTermination.ChimneyLocationOnRoof.Slope]
    given Decoder[I18nData.LocalConditions.ChimneyTermination.ChimneyLocationOnRoof.OutsideAirIntakeAndChimneyLocations] = deriveDecoder[I18nData.LocalConditions.ChimneyTermination.ChimneyLocationOnRoof.OutsideAirIntakeAndChimneyLocations]
    given Decoder[I18nData.LocalConditions.ChimneyTermination.ChimneyLocationOnRoof.HorizontalDistanceBetweenChimneyAndRidgelineBis] = deriveDecoder[I18nData.LocalConditions.ChimneyTermination.ChimneyLocationOnRoof.HorizontalDistanceBetweenChimneyAndRidgelineBis]
    given Decoder[I18nData.LocalConditions.ChimneyTermination.AdjacentBuildings] = deriveDecoder[I18nData.LocalConditions.ChimneyTermination.AdjacentBuildings]
    given Decoder[I18nData.LocalConditions.ChimneyTermination.AdjacentBuildings.HorizontalDistanceBetweenChimneyAndAdjacentBuildings] = deriveDecoder[I18nData.LocalConditions.ChimneyTermination.AdjacentBuildings.HorizontalDistanceBetweenChimneyAndAdjacentBuildings]
    given Decoder[I18nData.LocalConditions.ChimneyTermination.AdjacentBuildings.HorizontalAngleBetweenChimneyAndAdjacentBuildings] = deriveDecoder[I18nData.LocalConditions.ChimneyTermination.AdjacentBuildings.HorizontalAngleBetweenChimneyAndAdjacentBuildings]
    given Decoder[I18nData.LocalConditions.ChimneyTermination.AdjacentBuildings.VerticalAngleBetweenChimneyAndAdjacentBuildings] = deriveDecoder[I18nData.LocalConditions.ChimneyTermination.AdjacentBuildings.VerticalAngleBetweenChimneyAndAdjacentBuildings]
    ...
    given Decoder[I18nData.IncrementalValidation.NotDefinedYet]         = deriveDecoder[I18nData.IncrementalValidation.NotDefinedYet]
