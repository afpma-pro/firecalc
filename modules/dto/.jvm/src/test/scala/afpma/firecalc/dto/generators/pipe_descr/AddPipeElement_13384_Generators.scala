...
trait AddPipeElement_13384_Generators extends PrimitiveGenerators with PipeShapeGenerators:
    ...
    def genAddSharpeAngle_0_to_90_Unsafe_FlowOnly_13384
        : Gen[AddFlowOnlyPipeElement_13384_V1.AddSharpeAngle_0_to_90_Unsafe] =
        for
            name  <- genSectionName
            angle <- Gen.choose(0.0, 90.0).map(_.degrees)
