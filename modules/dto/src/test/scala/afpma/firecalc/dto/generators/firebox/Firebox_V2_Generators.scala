...
trait Firebox_V2_Generators extends Firebox_V1_Generators:

    def genTraditional_V2: Gen[Firebox_V2.Traditional] =
        for
    ...
    def genEcoLabeled_V2: Gen[Firebox_V2.EcoLabeled] =
        for
            heat_output_reduced <- genHeatOutputReduced
            version <- genVersion
            air_intake_shape <-
    ...
    def genAFPMA_PRSE_V2: Gen[Firebox_V2.AFPMA_PRSE] =
        for
            heat_output_reduced <- genHeatOutputReduced
    ...
    def genFirebox_V2: Gen[Firebox_V2] =
        Gen.frequency(
            (5, genTraditional_V2),
            (3, genEcoLabeled_V2),
            (2, genAFPMA_PRSE_V2)
