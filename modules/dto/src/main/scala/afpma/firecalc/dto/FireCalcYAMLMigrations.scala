...
object FireCalcYAMLMigrations:
    ...
    def migrateV6ToV7(v6: FireCalcYAML_V6): FireCalcYAML_V7 =
        v6.transformInto[FireCalcYAML_V7]

    def upgradeToCurrent(dto: Any): Either[Throwable, FireCalcYAML] =
        dto match
            case fcv7: FireCalcYAML_V7 =>
                Right(fcv7)
            case fcv6: FireCalcYAML_V6 =>
                Right(migrateV6ToV7(fcv6))
            case fcv5: FireCalcYAML_V5 =>
                Right((migrateV5ToV6 andThen migrateV6ToV7)(fcv5))
            case fcv4: FireCalcYAML_V4 =>
                Right((migrateV4ToV5 andThen migrateV5ToV6 andThen migrateV6ToV7)(fcv4))
            case fcv3: FireCalcYAML_V3 =>
                Right((migrateV3ToV4 andThen migrateV4ToV5 andThen migrateV5ToV6 andThen migrateV6ToV7)(fcv3))
            case fcv2: FireCalcYAML_V2 =>
                Right(
                    (migrateV2ToV3 andThen migrateV3ToV4 andThen migrateV4ToV5 andThen migrateV5ToV6 andThen migrateV6ToV7)(
                        fcv2
                    )
                )
            case fcv1: FireCalcYAML_V1 =>
                Right(
                    (migrateV1ToV2 andThen migrateV2ToV3 andThen migrateV3ToV4 andThen migrateV4ToV5 andThen migrateV5ToV6 andThen migrateV6ToV7)(
                        fcv1
                    )
                )
            case other =>
        ...
        detectVersion(json) match
            ...
            case Some(2)       =>
                decodeWithFallback(
                    ...
                    3,
                    decodeV3,
                    migrateV3ToV4 andThen migrateV4ToV5 andThen migrateV5ToV6 andThen migrateV6ToV7
                )
            case Some(3)       =>
                decodeWithFallback(
                    json,
                    ...
                    4,
                    decodeV4,
                    migrateV4ToV5 andThen migrateV5ToV6 andThen migrateV6ToV7
                )
            case Some(4)       =>
                decodeWithFallback(
                    json,
                    ...
                    5,
                    decodeV5,
                    migrateV5ToV6 andThen migrateV6ToV7
                )
            case Some(5)       =>
                decodeWithFallback(json, 5, decodeV5, migrateV5ToV6 andThen migrateV6ToV7, 6, decodeV6, migrateV6ToV7)
            case Some(6)       =>
                decodeV6(json).map(migrateV6ToV7)
            case Some(7)       =>
                decodeV7(json)
            case Some(version) =>
    ...
    /** Decode V7 from JSON using FireCalcYAML_V7 decoder. */
    private def decodeV7(json: Json): Either[String, FireCalcYAML_V7] =
        import FireCalcYAML_V7.decoder
        json.as[FireCalcYAML_V7].left.map(e => s"Failed to decode V7: ${e.getMessage()}")
