...
sealed trait ThermalPipeDescr_13384_V2

sealed trait SetThermalPipeProp_13384_V2 extends ThermalPipeDescr_13384_V2

object SetThermalPipeProp_13384_V2:

    @Transl(I(_.set_prop.SetInnerShape))
    case class SetInnerShape(
        @Transl(I(_.terms.pipe_shape._self))
        shape: PipeShape
    ) extends SetThermalPipeProp_13384_V2
    ...
    case class SetMaterial(
        @Transl(I(_.set_prop.SetMaterial))
        material: Material_13384_V2 // Material_13384_V1 changed to Material_13384_V2
    ) extends SetThermalPipeProp_13384_V2
...
sealed trait AddThermalPipeElement_13384_V2 extends ThermalPipeDescr_13384_V2:
    def name: String

object AddThermalPipeElement_13384_V2:
