...
sealed trait FlowOnlyPipeDescr_15544

sealed trait SetFlowOnlyPipeProp_15544 extends FlowOnlyPipeDescr_15544

object SetFlowOnlyPipeProp_15544:

    @Transl(I(_.set_prop.SetInnerShape))
    case class SetInnerShape(
        @Transl(I(_.terms.pipe_shape._self))
        shape: PipeShape
    ) extends SetFlowOnlyPipeProp_15544
...
sealed trait AddFlowOnlyPipeElement_15544 extends FlowOnlyPipeDescr_15544:
    def name: String

object AddFlowOnlyPipeElement_15544:
    ...
    ) extends AddFlowOnlyPipeElement_15544
