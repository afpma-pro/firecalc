...
sealed trait FlowOnlyPipeDescr_13384

sealed trait SetFlowOnlyPipeProp_13384 extends FlowOnlyPipeDescr_13384

object SetFlowOnlyPipeProp_13384:

    @Transl(I(_.set_prop.SetInnerShape))
    case class SetInnerShape(
        @Transl(I(_.terms.pipe_shape._self))
        shape: PipeShape
    ) extends SetFlowOnlyPipeProp_13384
...
sealed trait AddFlowOnlyPipeElement_13384 extends FlowOnlyPipeDescr_13384:
    def name: String

object AddFlowOnlyPipeElement_13384:
    ...
    ) extends AddFlowOnlyPipeElement_13384
