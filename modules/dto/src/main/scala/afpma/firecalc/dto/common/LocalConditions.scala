...
object LocalConditions:
    ...
    object ChimneyTermination:
        ...
        case class ChimneyLocationOnRoof private (
            ...
            horizontal_distance_between_chimney_and_ridgeline    : Option[
                ChimneyLocationOnRoof.HorizontalDistanceBetweenChimneyAndRidgeline
            ],
            ...
            horizontal_distance_between_chimney_and_ridgeline_bis: Option[
                ChimneyLocationOnRoof.HorizontalDistanceBetweenChimneyAndRidgelineBis
            ]
        )
        ...
        object ChimneyLocationOnRoof:
            ...
            def I18N_WRoof
                : Locale ?=> afpma.firecalc.i18n.I18nData.LocalConditionsObj.ChimneyTermination.ChimneyLocationOnRoof =
            ...
            object OutsideAirIntakeAndChimneyLocations:
                ...
                given ShowUsingLocale[OutsideAirIntakeAndChimneyLocations] = showUsingLocale:
                    case OnDifferentSidesOfRidgeline =>
                        I18N_WRoof.outside_air_intake_and_chimney_locations.on_different_sides_of_the_ridge
                    case OnSameSideOfRidgeline       =>
                        I18N_WRoof.outside_air_intake_and_chimney_locations.on_same_side_of_the_ridge
        ...
        case class AdjacentBuildings private (
            ...
            horizontal_angle_between_chimney_and_adjacent_buildings   : Option[
                HorizontalAngleBetweenChimneyAndAdjacentBuildings
            ],
            vertical_angle_between_chimney_and_adjacent_buildings     : Option[
                VerticalAngleBetweenChimneyAndAdjacentBuildings
            ]
        )
        ...
        object AdjacentBuildings:
            ...
            def I18N_WAdj
                : Locale ?=> afpma.firecalc.i18n.I18nData.LocalConditionsObj.ChimneyTermination.AdjacentBuildings =
            ...
            object HorizontalDistanceBetweenChimneyAndAdjacentBuildings:
                ...
                given ShowUsingLocale[HorizontalDistanceBetweenChimneyAndAdjacentBuildings] = showUsingLocale:
                    case LessThan15m =>
                        I18N_WAdj.horizontal_distance_between_chimney_and_adjacent_buildings.less_than_15m
                    case MoreThan15m =>
                        I18N_WAdj.horizontal_distance_between_chimney_and_adjacent_buildings.more_than_15m
            ...
            object HorizontalAngleBetweenChimneyAndAdjacentBuildings:
                ...
                given ShowUsingLocale[HorizontalAngleBetweenChimneyAndAdjacentBuildings] = showUsingLocale:
                    case MoreThan30Deg =>
                        I18N_WAdj.horizontal_angle_between_chimney_and_adjacent_buildings.more_than_30deg
                    case LessThan30Deg =>
                        I18N_WAdj.horizontal_angle_between_chimney_and_adjacent_buildings.less_than_30deg
            ...
            object VerticalAngleBetweenChimneyAndAdjacentBuildings:
                ...
                given ShowUsingLocale[VerticalAngleBetweenChimneyAndAdjacentBuildings] = showUsingLocale:
                    case MoreThan10DegAboveHorizon =>
                        I18N_WAdj.vertical_angle_between_chimney_and_adjacent_buildings.more_than_10deg_above_horizon
                    case LessThan10DegOverHorizon  =>
                        I18N_WAdj.vertical_angle_between_chimney_and_adjacent_buildings.less_than_10deg_above_horizon
