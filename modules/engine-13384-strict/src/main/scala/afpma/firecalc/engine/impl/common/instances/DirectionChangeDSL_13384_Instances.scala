...
import afpma.firecalc.engine.typeclasses.DirectionChangeDSL_13384
...
object DirectionChangeDSL_13384_Instances:
    ...
    given thermal13384: DirectionChangeDSL_13384[ThermalPipeDescr_13384] with
        def addAngleVifDe0A90(name: String, angle: QtyD[Degree], absDir: AbsoluteDirection) =
            AddThermalPipeElement_13384.AddSharpeAngle_0_to_90(name, angle, Some(absDir))

        def addAngleVifDe0A90_unsafe(name: String, angle: QtyD[Degree], absDir: AbsoluteDirection) =
            AddThermalPipeElement_13384.AddSharpeAngle_0_to_90_Unsafe(name, angle, Some(absDir))

        def addCoudeCourbe90(name: String, R: QtyD[Meter], absDir: AbsoluteDirection) =
            AddThermalPipeElement_13384.AddSmoothCurve_90(name, R, Some(absDir))

        def addCoudeCourbe90_unsafe(name: String, R: QtyD[Meter], absDir: AbsoluteDirection) =
            AddThermalPipeElement_13384.AddSmoothCurve_90_Unsafe(name, R, Some(absDir))

        def addCoudeCourbe60(name: String, R: QtyD[Meter], absDir: AbsoluteDirection) =
            AddThermalPipeElement_13384.AddSmoothCurve_60(name, R, Some(absDir))

        def addCoudeCourbe60_unsafe(name: String, R: QtyD[Meter], absDir: AbsoluteDirection) =
            AddThermalPipeElement_13384.AddSmoothCurve_60_Unsafe(name, R, Some(absDir))

        def addCoudeASegment90Avec2A45(name: String, R: QtyD[Meter], absDir: AbsoluteDirection) =
            AddThermalPipeElement_13384.AddElbows_2x45(name, R, Some(absDir))

        def addCoudeASegment90Avec3A30(name: String, R: QtyD[Meter], absDir: AbsoluteDirection) =
            AddThermalPipeElement_13384.AddElbows_3x30(name, R, Some(absDir))
    ...
    given flowOnly13384: DirectionChangeDSL_13384[FlowOnlyPipeDescr_13384] with
        def addAngleVifDe0A90(name: String, angle: QtyD[Degree], absDir: AbsoluteDirection) =
            AddFlowOnlyPipeElement_13384.AddSharpeAngle_0_to_90(name, angle, Some(absDir))

        def addAngleVifDe0A90_unsafe(name: String, angle: QtyD[Degree], absDir: AbsoluteDirection) =
            AddFlowOnlyPipeElement_13384.AddSharpeAngle_0_to_90_Unsafe(name, angle, Some(absDir))

        def addCoudeCourbe90(name: String, R: QtyD[Meter], absDir: AbsoluteDirection) =
            AddFlowOnlyPipeElement_13384.AddSmoothCurve_90(name, R, Some(absDir))

        def addCoudeCourbe90_unsafe(name: String, R: QtyD[Meter], absDir: AbsoluteDirection) =
            AddFlowOnlyPipeElement_13384.AddSmoothCurve_90_Unsafe(name, R, Some(absDir))

        def addCoudeCourbe60(name: String, R: QtyD[Meter], absDir: AbsoluteDirection) =
            AddFlowOnlyPipeElement_13384.AddSmoothCurve_60(name, R, Some(absDir))

        def addCoudeCourbe60_unsafe(name: String, R: QtyD[Meter], absDir: AbsoluteDirection) =
            AddFlowOnlyPipeElement_13384.AddSmoothCurve_60_Unsafe(name, R, Some(absDir))

        def addCoudeASegment90Avec2A45(name: String, R: QtyD[Meter], absDir: AbsoluteDirection) =
            AddFlowOnlyPipeElement_13384.AddElbows_2x45(name, R, Some(absDir))

        def addCoudeASegment90Avec3A30(name: String, R: QtyD[Meter], absDir: AbsoluteDirection) =
            AddFlowOnlyPipeElement_13384.AddElbows_3x30(name, R, Some(absDir))
