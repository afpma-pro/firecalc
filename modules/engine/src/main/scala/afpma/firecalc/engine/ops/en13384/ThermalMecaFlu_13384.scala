...
private abstract trait MecaFlu_EN13384_PipeSectionResult_Impl(
    ...
    last_InnerGeom: Option[PipeShape],
    prevO: Option[PipeSectionResult[PipeElDescr]],
) extends PipeSectionResult[PipeElDescr] with ThermalMecaFlu_Helpers:
    ...
    private def mkPipeWithGasFlowWithLength(
        ...
        length: Length,
    ): Either[models.en13384.ThermalPipeDescr_13384.Error.OnlyAStraightSectionCanBeConvertedToPipeWithGasFlow.type, PipeWithGasFlow] = 
        ...
        curr.typ match
            case ConnectorPipeT | ChimneyPipeT => 
                mkPipeWithGasFlowWithLength(temp_mean, massFlow, exteriorAir, custom_section_length) match // te, temp_mean, to ???
                    ...
                    case Left(models.en13384.ThermalPipeDescr_13384.Error.OnlyAStraightSectionCanBeConvertedToPipeWithGasFlow) =>
                        prevO match
...
private abstract trait MecaFlu_13384_PipeResult_Impl(
    ...
    gas: Gas,
    params: Params_13384,
) extends PipeResult.WithSections with ThermalMecaFlu_Helpers:
