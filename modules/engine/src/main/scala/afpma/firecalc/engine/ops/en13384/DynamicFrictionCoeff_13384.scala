...
object DynamicFrictionCoeff_13384:
    ...
    import afpma.firecalc.engine.models.en13384.{
        FlowOnlyPipeDescr_13384 => FlowOnly,
        ThermalPipeDescr_13384 => Thermal
    }
    ...
    given flowOnlyDirectionChange: DynamicFrictionCoeffOp[FlowOnly.DirectionChange] =
        new DynamicFrictionCoeffOp[FlowOnly.DirectionChange]:
            extension (s: FlowOnly.DirectionChange) def dynamicFrictionCoeff: DynamicFrictionCoeffOp.Result =
                s match
                    case ss: FlowOnly.AngleSpecifique        => flowOnlyAngleSpecifique.dynamicFrictionCoeff(ss)
                    case ss: FlowOnly.AngleVifDe0A90_Unsafe  => flowOnlyAngleVifDe0A90_unsafe.dynamicFrictionCoeff(ss)
    ...
    given flowOnlySectionGeometryChange: DynamicFrictionCoeffOp[FlowOnly.SectionGeometryChange] =
        new DynamicFrictionCoeffOp[FlowOnly.SectionGeometryChange]:
            extension (s: FlowOnly.SectionGeometryChange) def dynamicFrictionCoeff: DynamicFrictionCoeffOp.Result =
                s match
    ...
    given flowOnlyUnion: DynamicFrictionCoeffOp[FlowOnly.SingularFlowResistance | FlowOnly.DirectionChange | FlowOnly.SectionGeometryChange] =
        new DynamicFrictionCoeffOp[FlowOnly.SingularFlowResistance | FlowOnly.DirectionChange | FlowOnly.SectionGeometryChange]:
            extension (s: FlowOnly.SingularFlowResistance | FlowOnly.DirectionChange | FlowOnly.SectionGeometryChange) 
                def dynamicFrictionCoeff: DynamicFrictionCoeffOp.Result =
                    s match
                        case x: FlowOnly.SingularFlowResistance => flowOnlySingularFlowResistance.dynamicFrictionCoeff(x)
    ...
    given thermalDirectionChange: DynamicFrictionCoeffOp[Thermal.DirectionChange] =
        new DynamicFrictionCoeffOp[Thermal.DirectionChange]:
            extension (s: Thermal.DirectionChange) def dynamicFrictionCoeff: DynamicFrictionCoeffOp.Result =
                s match
    ...
    given thermalSectionGeometryChange: DynamicFrictionCoeffOp[Thermal.SectionGeometryChange] =
        new DynamicFrictionCoeffOp[Thermal.SectionGeometryChange]:
            extension (s: Thermal.SectionGeometryChange) def dynamicFrictionCoeff: DynamicFrictionCoeffOp.Result =
                s match
    ...
    given thermalUnion: DynamicFrictionCoeffOp[Thermal.SingularFlowResistance | Thermal.DirectionChange | Thermal.SectionGeometryChange] =
        new DynamicFrictionCoeffOp[Thermal.SingularFlowResistance | Thermal.DirectionChange | Thermal.SectionGeometryChange]:
    ...
    private def yHeaderForShape123[S](shape: S)(using show_shape: Show[S]): Option[Double] => Either[DynamicFrictionCoeffOp.Err, String] =
