...
trait HasPipeModules_15544Only_MCE extends HasPipeModules_15544Only_Alg:
    final override type CombustionAirPipe_Module_T = CombustionAirPipe_Module_13384.type
    final override type FireboxPipe_Module_T       = FireboxPipe_Module_13384.type
    final override type FluePipe_Module_T          = FluePipe_Module_13384.type

    final override val CombustionAirPipe_Module        = CombustionAirPipe_Module_13384
    final override val FireboxPipe_Module              = FireboxPipe_Module_13384
    final override val FluePipe_Module                 = FluePipe_Module_13384
