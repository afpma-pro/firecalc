    ...
    val heatingAppliance = HeatingAppliance(
        ...
        temperatures      =
            ...
            HeatingAppliance.Temperatures(
                flue_gas_temp_nominal =
                    155.2.degreesCelsius, // 186.2°C selon doc mais température ajustée à 20% quand prise de mesure et point d'entrée sont séparées de 1m ou 1m50
        ...
        massFlows         =
            ...
            HeatingAppliance.MassFlows      (
                ...
                combustion_air_mass_flow_nominal =
                    (4.70.g_per_s: MassFlow).some, // 8.45 g/s in KESA-C2.pdf ??? 4.7 g/s in QC2 ???
