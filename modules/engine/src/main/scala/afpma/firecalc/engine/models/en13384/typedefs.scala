...
object typedefs:
    ...
    object TemperatureRequirements_13384:
         ...
         * @return
         */
        def forDryOperatingConditions(tob: TCelsius, tig: TCelsius, tiob: TCelsius, tsp: TCelsius)(using
            lq         : LoadQty,
            flueGasCond: FlueGasCondition.Dry_NonCondensing.type
        ) =
         ...
         * @return
         */
        def forWetOperatingConditions(tob: TCelsius, tig: TCelsius, tiob: TCelsius, tsp: TCelsius)(using
            lq         : LoadQty,
            flueGasCond: FlueGasCondition.Wet_Condensing.type
        ) =
            TemperatureRequirements_13384(
                atLoadQty = lq,
                tob       = tob,
    ...
    object FlueGasTemperatureAtLowestPossibleHeatOutput extends OTypedTempD[Kelvin]:
    ...
    object CoefficientOfCoolingForConnectingFluePipe extends OTypedQtyD[1]:
    ...
    object T_uo_temperature:
        ...
        extension       (x              : T_uo_temperature         ) def unwrap: Option[AmbiantAirTemperatureSet] = x
