...
trait FlowOnlyIncrementalBuilder_15544 extends IncrementalBuilderAlg:
    ...
    override given hasInnerShapeAtPos: HasInnerShapeAtPos[PipeElDescr] = afpma.firecalc.engine.models.en15544.FlowOnlyPipeDescr_15544.hasInnerShapeAtPos
    override given hasLength: HasLength[PipeElDescr] = afpma.firecalc.engine.models.en15544.FlowOnlyPipeDescr_15544.hasLength
    override given hasVerticalElev: HasVerticalElev[PipeElDescr] = afpma.firecalc.engine.models.en15544.FlowOnlyPipeDescr_15544.hasVerticalElev
    given showPipeElDescr: Show[PipeElDescr] = afpma.firecalc.engine.models.en15544.FlowOnlyPipeDescr_15544.showPipeElDescr
