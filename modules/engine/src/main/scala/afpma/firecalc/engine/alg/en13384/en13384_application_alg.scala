...
trait EN13384_1_A1_2019_Application_Alg extends Standard with HasTypeMembers_13384_Alg:
    ...
    def airIntake_PipeResult_withVentilationOpenings(
    ...
    def pressureRequirements
        : PressureRequirementsOp[WithLoadQty[ValidatedNel[MecaFlu_Error, PressureRequirements_13384]]]
