...
import afpma.firecalc.catalog.{CatalogCategoryInstances, CatalogFile}
...
object CatalogState:
    val empty: CatalogState = CatalogState(Map.empty, Map.empty)
...
object CatalogStateCodec:
    ...
    given Decoder[CatalogState] = Decoder.instance { c =>
        ...
        yield CatalogState(fireboxes, presets)
    }
