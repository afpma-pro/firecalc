...
final case class AppendLayersComponent(
    ...
    private def renderElemTyped[AA <: AppendLayerDescr](
        i    : Int,
        title: String,
        aa   : AA,
    ...
    lazy val rendered_elems_sig: Signal[Seq[HtmlElement]] =
        ...
        welem_xtraoutput_sig.signal
            ...
            .handleCase[(Int, AppendLayerDescr, XtraOutputs), (Int, FromLambda, XtraOutputs), HtmlElement] {
                case (i, aa: FromLambda, x) => (i, aa, x)
            } { (iaax, sig) => renderElemTyped[FromLambda](iaax._1, I18N.append_layer_descr.FromLambda, iaax._2, sig) }
            .handleCase[
                (Int, AppendLayerDescr, XtraOutputs        ),
                (Int, FromLambdaUsingThickness, XtraOutputs),
                HtmlElement
            ] { case (i, aa: FromLambdaUsingThickness, x) => (i, aa, x) } { (iaax, sig) =>
                renderElemTyped[FromLambdaUsingThickness](
                    iaax._1,
                    I18N.append_layer_descr.FromLambdaUsingThickness,
                    iaax._2,
                    sig
                )
            }
            .handleCase[
                (Int, AppendLayerDescr, XtraOutputs                   ),
                (Int, FromThermalResistanceUsingThickness, XtraOutputs),
                HtmlElement
            ] { case (i, aa: FromThermalResistanceUsingThickness, x) => (i, aa, x) } { (iaax, sig) =>
                renderElemTyped[FromThermalResistanceUsingThickness](
                    iaax._1,
                    I18N.append_layer_descr.FromThermalResistanceUsingThickness,
                    iaax._2,
                    sig
                )
            }
            .handleCase[(Int, AppendLayerDescr, XtraOutputs), (Int, FromThermalResistance, XtraOutputs), HtmlElement] {
                case (i, aa: FromThermalResistance, x) => (i, aa, x)
            } { (iaax, sig) =>
                renderElemTyped[FromThermalResistance](
                    iaax._1,
                    I18N.append_layer_descr.FromThermalResistance,
                    iaax._2,
                    sig
                )
            }
            .handleCase[
                (Int, AppendLayerDescr, XtraOutputs       ),
                (Int, AirSpaceUsingOuterShape, XtraOutputs),
                HtmlElement
            ] { case (i, aa: AirSpaceUsingOuterShape, x) => (i, aa, x) } { (iaax, sig) =>
                renderElemTyped[AirSpaceUsingOuterShape](
                    iaax._1,
                    I18N.append_layer_descr.AirSpaceUsingOuterShape,
                    iaax._2,
                    sig
                )
            }
            .handleCase[(Int, AppendLayerDescr, XtraOutputs), (Int, AirSpaceUsingThickness, XtraOutputs), HtmlElement] {
                case (i, aa: AirSpaceUsingThickness, x) => (i, aa, x)
            } { (iaax, sig) =>
                renderElemTyped[AirSpaceUsingThickness](
                    iaax._1,
                    I18N.append_layer_descr.AirSpaceUsingThickness,
                    iaax._2,
                    sig
                )
            }
    ...
    override def renderContent: HtmlElement =
        div(
            ...
            div(
                ...
                div(
                    cls := "flex-none",
                    TagTreeMenuComponent[AppendLayerDescr](sampleTree, command_bus.writer, elems_size_v).node
                )
                // debug
                // div(cls := "flex-none",
