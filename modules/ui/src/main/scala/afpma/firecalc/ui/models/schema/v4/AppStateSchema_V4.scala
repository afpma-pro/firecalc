...
package afpma.firecalc.ui.models.schema.v4
...
/**
 * Unified application state schema V4 (UI module).
 *
 ...
 * - Compile-time guarantee that AppStateSchema_V4 contains FireCalcYAML_V4
 ...
 */
final case class AppStateSchema_V4(
    version: AppStateSchema_Version = AppStateSchema_Version(4),

    /** Versioned engine state - sent to backend for PDF generation */
    engine_state: FireCalcYAML_V4,
...
object AppStateSchema_V4:

    import afpma.firecalc.ui.instances.circe.{given_Decoder_BillingInfo, given_Encoder_BillingInfo}

    given Encoder[AppStateSchema_V4] = semiauto.deriveEncoder[AppStateSchema_V4]
    given Decoder[AppStateSchema_V4] = semiauto.deriveDecoder[AppStateSchema_V4]
