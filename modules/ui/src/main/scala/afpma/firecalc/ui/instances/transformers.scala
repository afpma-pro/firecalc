...
import afpma.firecalc.ui.models.BillingInfoWithLanguage
...
object transformers:
    ...
    given Transformer[BillableCountry, CountryCode_ISO_3166_1_ALPHA_2] = { case BillableCountry.France =>
        CountryCode_ISO_3166_1_ALPHA_2.FR
    }
    ...
    given billingInfoToCustomerInfo: Transformer[BillingInfo, CustomerInfo] =
        Transformer
            .define[BillingInfo, CustomerInfo]
