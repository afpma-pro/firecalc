...
case class BillingInfoUI()(using Locale):
    ...
    given DaisyUIVerticalForm[BillingInfo_Version] =
        DaisyUIVerticalForm.makeFor[BillingInfo_Version](summon[Defaultable[BillingInfo_Version]]):
            (variable, formConfig) =>
    ...
    given DaisyUIVerticalForm[BillingInfo] =
        ...
        DaisyUIVerticalForm.autoDerived[BillingInfo].autoOverwriteFieldNames
