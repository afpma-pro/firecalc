...
import afpma.firecalc.payments.shared.api.v1.BackendCompatibleLanguage
import afpma.firecalc.payments.shared.api.v1.CountryCode_ISO_3166_1_ALPHA_2
import afpma.firecalc.payments.shared.api.v1.CustomerInfo_V1
import afpma.firecalc.payments.shared.api.v1.CustomerType
...
object PaymentTransformers:
    ...
    given billingInfo_V1_to_customerInfo_V1: Transformer[BillingInfo_V1, CustomerInfo_V1] =
        Transformer
            .define[BillingInfo_V1, CustomerInfo_V1]
            ...
            .withFieldComputed(_.language, _ => BackendCompatibleLanguage.French) // Default, should come from locale
            ...
            .withFieldComputed(_.addressLine1, bi => if (bi.address_line1.isEmpty) None else Some(bi.address_line1))
            .withFieldComputed(_.addressLine2, _.address_line2)
            .withFieldComputed(_.addressLine3, _.address_line3)
            .withFieldComputed(_.city, bi => if (bi.city.isEmpty) None else Some(bi.city))
            .withFieldComputed(_.region, _.region)
            .withFieldComputed(_.postalCode, bi => if (bi.postal_code.isEmpty) None else Some(bi.postal_code))
            .withFieldComputed(
                _.countryCode,
                bi =>
