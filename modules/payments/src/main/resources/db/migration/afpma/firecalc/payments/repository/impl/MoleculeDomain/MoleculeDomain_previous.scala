...
import afpma.firecalc.payments.repository.impl.dsl.MoleculeDomain.PaymentProvider
...
import afpma.firecalc.payments.shared.api.CustomerType
...
trait MoleculeDomain extends DomainStructure:
    ...
    trait ProductOrder {
        ...
        val productMetadata = manyToOne[ProductMetadata]
...
object CustomerSyntax:
    ...
    private def parseCustomerType(customerTypeStr: String): CustomerType =
        CustomerType.values
            .find(_.toString == customerTypeStr)
    ...
    extension (
        tuple: (
            ...
            Option[String],
            Option[String],
            Option[CountryCode_ISO_3166_1_ALPHA_2],
            Option[String],
            Option[String],
            Option[domain.PaymentProvider],
            Instant
        )
    )
        def toDomainCustomer: domain.Customer =
