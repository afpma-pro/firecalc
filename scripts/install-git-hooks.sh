...
echo "  • Detect potential secrets in staged diffs"
echo "  • Verify Scala/SBT files are formatted (when staged) — points you at 'make fmt' if not"
echo "  • Block commits if any check fails"
echo "  • Provide helpful error messages with format examples"
echo ""
